                ...
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="name" placeholder="连接名" autocomplete="off"
                                   class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
    ...
    layui.use(['table', 'form'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {title: "连接名", field: "name"},
                {title: "地址", field: "url"},
                {title: "打开方式", field: "target"},
        ...
        table.on("tool(dataList)", function (obj) {
            ...
            if (event === "delete") {
                ...
                xadmin.open("修改连接", "href/edit?id=" + bannerId, 500, 400)
            }
        });
        table.on("toolbar(dataList)", function (obj) {
            if (obj.event === "add") {
                xadmin.open("添加连接", "href/edit", 500, 400)
            }
        });
