...
<div style="width: 90%;margin: 0 30px 0 auto">
    <form id="edit" lay-filter="edit" class="layui-form">
        <input type="hidden" name="tagId" id="tagId" value="${category.tagId}">
        <div class="layui-form-item">
            <label class="layui-form-label" for="name"><span class="x-red">*</span>分类名</label>
            <div class="layui-input-block">
                <input type="text" name="name" id="name" placeholder="请输入分类名" autocomplete="off"
                       value="${category.name}" lay-verify="required" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <textarea placeholder="请输入内容" id="profile" name="profile"
                  class="layui-textarea">${category.profile}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
